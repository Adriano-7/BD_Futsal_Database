...
CREATE TABLE Jogo (
    ...
    nomeEquipaVisitada VARCHAR (75) REFERENCES Equipa (nome) ON DELETE CASCADE ON UPDATE CASCADE NOT NULL, 
    nomeEquipaVisitante VARCHAR (75) REFERENCES Equipa (nome) ON DELETE CASCADE ON UPDATE CASCADE NOT NULL, 
    arbitro INTEGER REFERENCES Arbitro (idArbitro) ON DELETE CASCADE ON UPDATE CASCADE NOT NULL, 
    ...
    CHECK ((numeroJornada IS NULL AND fasePlayOff IS NOT NULL) OR (numeroJornada IS NOT NULL AND fasePlayOff IS NULL))
);
